  ...
  List<PageViewModel> getPages() {
    return [
      ...
      PageViewModel(
        ...
        footer: Text("Choose from Text chat, Video chat, or Live Video Call"),
      ),
      //-----------------------------------------------------------Privacy
      PageViewModel(
      ...
      PageViewModel(
        ...
        footer: Text("Lifestyle  Education  Electronics  Household"),
      ),
      //-----------------------------------------------------------All set
      PageViewModel(
        ...
        footer: Text("If you still have questions, visit our FAQ section"),
      ),
    ];
  }
      ...
      body: IntroductionScreen(
        ...
        onDone: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      placeholder())); // go to placeholder when done is pressed
        },
      ),
    );
  }
